...
- US Department of State: Panama International Travel Information
  ...
  - Note: Direct fetch was blocked by Cloudflare during this pass, but search result text surfaced the passport validity note. Recheck manually before final travel.
- Embassy of Panama: Visas / immigration and visas
  - https://www.embassyofpanama.org/visas-1
  - Notes used: United States listed under no-visa-required countries; US and Canadian citizens may stay up to 180 days as tourists; guidance mentions minimum passport validity, round-trip ticket, and proof of economic solvency.
- CDC Travelers' Health: Panama
  - https://wwwnc.cdc.gov/travel/destinations/traveler/none/panama
  - Notes used: bug-bite prevention, malaria risk in some areas, travel health kit, outdoor/heat/water safety, medical evacuation considerations.

## Useful Non-Official Weather/Planning References

- Rough Guides: Panama weather in July
  - https://www.roughguides.com/panama/when-to-go/july/
- Visit Bocas del Toro: rainy season note
  - https://go.bocasdeltoro.travel/blog/does-bocas-del-toro-have-a-rainy-season/

## Recheck Before Departure

- Entry requirements.
- Passport validity.
- Health recommendations and malaria-risk areas for the exact route.
- Weather for each region.
- Airline baggage rules, especially for domestic flights.
